function [best_proposals]= eod_mcmc_proposal_region(renderer, hog_region_pyramid, im_region, detectors, param, im, visualize)
      ...
      for chain_idx = 1:n_batch
        ...
        try
            [max_score, template, template_size, rendering_image, rendering_depth, image_bbox] =...
                eod_detect_using_instant_detector(renderer, hog_region_pyramid{region_idx}, ...
